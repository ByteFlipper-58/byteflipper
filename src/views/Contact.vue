...
const submitForm = async () => {
  try {
    ...
    const serviceID = 'service_98vkb3c'; // Замените на ваш service ID
    const templateID = 'template_ga32rnq'; // Замените на ваш template ID
    const userID = '0jknVGZofIk42r4Ae'; // Замените на ваш user ID
