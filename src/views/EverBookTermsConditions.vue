<template>
    <div>
       <body>
          <strong>EverBook Terms &amp; Conditions</strong><br>
          <p>These terms and conditions applies to the EverBook app (hereby referred to as "Application") for mobile devices that was created by ByteFlipper (hereby referred to as "Service Provider") as an Open Source service.</p>
          <br>
          ...
          <br>
          <p>These terms and conditions are effective as of 2024-12-25</p>
