<template>
  <div>
   ...
   <p>This privacy policy is applicable to the FF Sensitivities app (hereinafter referred to as "Application") for mobile devices, which was developed by ByteFlipper (hereinafter referred to as "Service Provider") as a a Free service. This service is provided "AS IS".</p>
   ...
   <br>
   <p>This privacy policy is effective as of 2024-10-16</p>
