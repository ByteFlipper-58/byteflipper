<template>
    <div>
       <body>
          <strong>EverBook Privacy Policy</strong>
          <p>This privacy policy is applicable to the EverBook app (hereinafter referred to as "Application") for mobile devices, which was developed by ByteFlipper (hereinafter referred to as "Service Provider") as a an Open Source service. This service is provided "AS IS".</p>
          <br><strong>What information does the Application obtain and how is it used?</strong><br><strong>User Provided Information</strong>
          ...
          <br><strong>Data Retention Policy, Managing Your Information</strong>
          <p>The Service Provider will retain User Provided data for as long as you use the Application and for a reasonable time thereafter. The Service Provider will retain Automatically Collected information for up to 24 months and thereafter may store it in aggregate. If you'd like the Service Provider to delete User Provided Data that you have provided via the Application, please contact them at byteflipper.business@gmail.com and we will respond in a reasonable time. Please note that some or all of the User Provided Data may be required in order for the Application to function properly.</p>
          ...
          <div>
             ...
             <p>The Application does not address anyone under the age of 13.
                ...
                personal information, please contact the Service Provider (byteflipper.business@gmail.com) so that
          ...
          <br>
          <p>This privacy policy is effective as of 2024-12-25</p>
          ...
          <p>If you have any questions regarding privacy while using the Application, or have questions about the practices, please contact the Service Provider via email at byteflipper.business@gmail.com.</p>
          <hr>
       </body>
    </div>
 </template>