<template>
    <div>
      ...
      <p>These terms and conditions applies to the FF Sensitivities app (hereby referred to as "Application") for mobile devices that was created by ByteFlipper (hereby referred to as "Service Provider") as a Free service.</p>
      <br>
      ...
      <div>
         ...
         <ul>
            ...
            <li><a :href="LINK_GOOGLE_ANALYTICS_TERMS" target="_blank" rel="noopener noreferrer">Google Analytics for Firebase</a></li> <!-- Оставляем эту ссылку, т.к. она есть в константах -->
         </ul>
      </div>
      <br>
      ...
      <br>
      <p>These terms and conditions are effective as of 2024-10-16</p>
      <br><strong>Contact Us</strong>
      <p>If you have any questions or suggestions about the Terms and Conditions, please do not hesitate to contact the Service Provider at byteflipper.business@gmail.com.</p>
      <hr>
      <p>This Terms and Conditions page was generated by <a :href="LINK_APP_PRIVACY_POLICY_GENERATOR" target="_blank" rel="noopener noreferrer">App Privacy Policy Generator</a></p>
   </body>
    </div>
  </template>
<script setup>
  import {
    ...
    LINK_ADMOB_TERMS,
    LINK_GOOGLE_ANALYTICS_TERMS,
    LINK_APP_PRIVACY_POLICY_GENERATOR
